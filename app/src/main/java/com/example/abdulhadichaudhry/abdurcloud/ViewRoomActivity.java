...
public class ViewRoomActivity extends AppCompatActivity {
    ...
    public FirebaseRecyclerAdapter<Room, Show_Chat_ViewHolder> mFirebaseAdapter;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mLinearLayoutManager = new LinearLayoutManager(ViewRoomActivity.this);
    ...
    public void onStart() {
        ...
        mFirebaseAdapter = new FirebaseRecyclerAdapter<Room, Show_Chat_ViewHolder>(Room.class, R.layout.single_room_item, Show_Chat_ViewHolder.class, myRef) {
            public void populateViewHolder(final Show_Chat_ViewHolder viewHolder, Room model, final int position) {
    ...
    public static class Show_Chat_ViewHolder extends RecyclerView.ViewHolder {
        ...
        public Show_Chat_ViewHolder(final View itemView) {
            ...
            layout = (LinearLayout)itemView.findViewById(R.id.singleroomitem);
